...
def eight_way_partition(
  ...
  strategy: str = 'AREA_PRIORITIZED',
) -> Dict[Vertex, Slot]:
  _logger.info('Use the %s strategy in floorplanning', strategy)

  if strategy == 'AREA_PRIORITIZED':
    return eight_way_partition_area_prioritized(
      init_v2s,
      slot_manager,
  ...
  elif strategy == 'SLR_CROSSING_PRIORITIZED':
    return eight_way_partition_slr_crossing_prioritized(
      init_v2s,
      slot_manager,
      grouping_constraints,
      pre_assignments,
    ...
    raise NotImplementedError('unrecognized strategy: %s', strategy)


def eight_way_partition_area_prioritized(
  init_v2s: Dict[Vertex, Slot],
  slot_manager: SlotManager,
  grouping_constraints: List[List[Vertex]],
  pre_assignments: Dict[Vertex, Slot],
...
def eight_way_partition_slr_crossing_prioritized(
  init_v2s: Dict[Vertex, Slot],
  slot_manager: SlotManager,
  grouping_constraints: List[List[Vertex]],
  pre_assignments: Dict[Vertex, Slot],
