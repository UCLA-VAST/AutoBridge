...
#pragma HLS INLINE OFF
  ...
  // io_L3
  // io_L2
  for (ap_uint<5> c1 = 0; c1 <= 11; c1 += 1) {
    // io_L1
    // pe
    for (ap_uint<5> c2 = 0; c2 <= 11; c2 += 1) {
    #pragma HLS PIPELINE II=1
      // access_coalesce
    {
      float fifo_data;
      fifo_data = A[c1 + 12*c2];
...
void A_IO_L1_in_intra_trans(float local_A[12][1], hls::stream<float> &fifo_A_local_out, bool intra_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void A_IO_L1_in_inter_trans(float local_A[12][1], hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_A_out, bool inter_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
  ...
  for (ap_uint<5> c1 = p1; c1 <= 11; c1 += 1) {
    // io_L1
    if (c1 == p1) {
      for (ap_uint<5> c2 = 0; c2 <= 11; c2 += 1) {
      #pragma HLS PIPELINE II=1
...
/* Module Definition */
template<int p0, int p1>
void A_IO_L1_in_inter_trans_boundary(float local_A[12][1], hls::stream<float> &fifo_A_in, bool inter_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS INLINE OFF
  ...
  // array
  // pe
  for (ap_uint<5> c2 = p0; c2 <= 11; c2 += 1) {
  #pragma HLS PIPELINE II=1
    {
      if (p0 == 0) {
...
#pragma HLS INLINE
  ...
  for (ap_uint<5> c1 = max(p0 + 1, p1); c1 <= 11; c1 += 1) {
  #pragma HLS PIPELINE II=1
    // io_L1
    if (c1 == p1) {
      // access_coalesce
...
#pragma HLS INLINE OFF
  ...
  // array
  // io_L3
  for (ap_uint<5> c0 = p0; c0 <= 10; c0 += 1) {
    // io_L2
    if (c0 == p0) {
      for (ap_uint<5> c1 = p0 + 1; c1 <= 11; c1 += 1) {
      #pragma HLS PIPELINE II=1
        // io_L1
        // access_coalesce
        float fifo_data;
      ...
      for (ap_uint<5> c1 = c0 + 1; c1 <= 11; c1 += 1) {
      #pragma HLS PIPELINE II=1
        // io_L1
        // access_coalesce
        float fifo_data;
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_intra_trans(float local_U[1][12], hls::stream<float> &fifo_U_drain_local_in)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_inter_trans(float local_U[1][12], hls::stream<float> &fifo_U_drain_in, hls::stream<float> &fifo_U_drain_out)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_inter_trans_boundary(float local_U[1][12], hls::stream<float> &fifo_U_drain_out)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS INLINE OFF
  ...
  // array
  // io_L3
  for (ap_uint<5> c0 = p0; c0 <= 11; c0 += 1) {
    // io_L2
    if (c0 == p0) {
      // io_L1
      // access_coalesce
