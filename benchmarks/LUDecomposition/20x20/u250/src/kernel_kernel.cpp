...
#pragma HLS INLINE OFF
  ...
  // io_L3
  // io_L2
  for (ap_uint<6> c1 = 0; c1 <= 19; c1 += 1) {
    // io_L1
    // pe
    for (ap_uint<6> c2 = 0; c2 <= 19; c2 += 1) {
    #pragma HLS PIPELINE II=1
      // access_coalesce
    {
      float fifo_data;
      fifo_data = A[c1 + 20*c2];
...
void A_IO_L1_in_intra_trans(float local_A[20][1], hls::stream<float> &fifo_A_local_out, bool intra_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void A_IO_L1_in_inter_trans(float local_A[20][1], hls::stream<float> &fifo_A_in, hls::stream<float> &fifo_A_out, bool inter_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
  ...
  for (ap_uint<6> c1 = p1; c1 <= 19; c1 += 1) {
    // io_L1
    if (c1 == p1) {
      for (ap_uint<6> c2 = 0; c2 <= 19; c2 += 1) {
      #pragma HLS PIPELINE II=1
...
/* Module Definition */
template<int p0, int p1>
void A_IO_L1_in_inter_trans_boundary(float local_A[20][1], hls::stream<float> &fifo_A_in, bool inter_trans_en)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS INLINE OFF
  ...
  // array
  // pe
  for (ap_uint<6> c2 = p0; c2 <= 19; c2 += 1) {
  #pragma HLS PIPELINE II=1
    {
      if (p0 == 0) {
...
#pragma HLS INLINE
  ...
  for (ap_uint<6> c1 = max(p0 + 1, p1); c1 <= 19; c1 += 1) {
  #pragma HLS PIPELINE II=1
    // io_L1
    if (c1 == p1) {
      // access_coalesce
...
#pragma HLS INLINE OFF
  ...
  // array
  // io_L3
  for (ap_uint<6> c0 = p0; c0 <= 18; c0 += 1) {
    // io_L2
    if (c0 == p0) {
      for (ap_uint<6> c1 = p0 + 1; c1 <= 19; c1 += 1) {
      #pragma HLS PIPELINE II=1
        // io_L1
        // access_coalesce
        float fifo_data;
      ...
      for (ap_uint<6> c1 = c0 + 1; c1 <= 19; c1 += 1) {
      #pragma HLS PIPELINE II=1
        // io_L1
        // access_coalesce
        float fifo_data;
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_intra_trans(float local_U[1][20], hls::stream<float> &fifo_U_drain_local_in)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_inter_trans(float local_U[1][20], hls::stream<float> &fifo_U_drain_in, hls::stream<float> &fifo_U_drain_out)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
/* Module Definition */
template<int p0, int p1>
void U_drain_IO_L1_out_inter_trans_boundary(float local_U[1][20], hls::stream<float> &fifo_U_drain_out)
{
#pragma HLS INLINE
  /* Variable Declaration */
  /* Variable Declaration */
...
#pragma HLS INLINE OFF
  ...
  // array
  // io_L3
  for (ap_uint<6> c0 = p0; c0 <= 19; c0 += 1) {
    // io_L2
    if (c0 == p0) {
      // io_L1
      // access_coalesce
...
#pragma HLS DATAFLOW disable_start_propagation
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<0, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<1, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<2, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<3, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<4, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<5, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<6, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<7, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<8, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<9, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<10, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<11, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<12, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<13, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<14, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<15, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<16, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<17, 19>(
  ...
  /* Module Call */
  L_drain_IO_L1_out_boundary<18, 19>(
