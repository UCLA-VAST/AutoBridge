    ...
    int32_t input_size_dim_1)
{
    ...
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_4_0("output_stream_4_0");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_4_1("output_stream_4_1");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_4_2("output_stream_4_2");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_4_3("output_stream_4_3");

    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_5_0("output_stream_5_0");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_5_1("output_stream_5_1");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_5_2("output_stream_5_2");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_5_3("output_stream_5_3");

    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_6_0("output_stream_6_0");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_6_1("output_stream_6_1");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_6_2("output_stream_6_2");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_6_3("output_stream_6_3");

    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_7_0("output_stream_7_0");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_7_1("output_stream_7_1");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_7_2("output_stream_7_2");
    tlp::stream<ap_uint<BURST_WIDTH>, 32 > output_stream_7_3("output_stream_7_3");
    ...
    tlp::task()
      ...
      .invoke<0>( compute, output_stream_4_0, output_stream_4_1, output_stream_4_2, output_stream_4_3, output_stream_3_0, output_stream_3_1, output_stream_3_2, output_stream_3_3, coalesced_data_num, tile_data_num, tile_num_dim_0, input_size_dim_0, input_size_dim_1)
      .invoke<0>( compute, output_stream_5_0, output_stream_5_1, output_stream_5_2, output_stream_5_3, output_stream_4_0, output_stream_4_1, output_stream_4_2, output_stream_4_3, coalesced_data_num, tile_data_num, tile_num_dim_0, input_size_dim_0, input_size_dim_1)
      .invoke<0>( compute, output_stream_6_0, output_stream_6_1, output_stream_6_2, output_stream_6_3, output_stream_5_0, output_stream_5_1, output_stream_5_2, output_stream_5_3, coalesced_data_num, tile_data_num, tile_num_dim_0, input_size_dim_0, input_size_dim_1)
      .invoke<0>( compute, output_stream_7_0, output_stream_7_1, output_stream_7_2, output_stream_7_3, output_stream_6_0, output_stream_6_1, output_stream_6_2, output_stream_6_3, coalesced_data_num, tile_data_num, tile_num_dim_0, input_size_dim_0, input_size_dim_1)
      .invoke<0>( store, var_output_0_0, output_stream_7_0, coalesced_data_num)
      .invoke<0>( store, var_output_0_1, output_stream_7_1, coalesced_data_num)
      .invoke<0>( store, var_output_0_2, output_stream_7_2, coalesced_data_num)
      .invoke<0>( store, var_output_0_3, output_stream_7_3, coalesced_data_num)
    ;
}
