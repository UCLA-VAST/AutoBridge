...
- **[01/06/2022]** With the help of AutoBridge and TAPA, [Serpens](https://arxiv.org/pdf/2111.12555.pdf) achieves 270 MHz on Alveo U280 while using 24 HBM channels, getting a 3.79X improvement over [GraphLily](https://ieeexplore.ieee.org/document/9643582).

- **[01/06/2022]** We are integrating AutoBridge and [TAPA](https://github.com/Blaok/tapa) to create a robust workflow. Currently AutoBridge relis on hacking the RTL generated by Vivado HLS, which makes it fragile. Instead, using the open-source TAPA compiler as the frontend will make the flow much more robust. While it is still in progress, feel free to contact me if you want to try it out, we will provide as much help as needed to make your design work! 
