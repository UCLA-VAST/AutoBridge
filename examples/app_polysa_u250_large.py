...
project_path = '/home/einsx7/pr/application/polysa_U250_large/orig_separate_pe/kernel0'
...
for i in range(13):
  for j in range(16):
    DDR_loc_2d_y[f'PE_wrapper_{i}_{j}_U0'] = int(j / 4)
    DDR_loc_2d_x[f'PE_wrapper_{i}_{j}_U0'] = 0 if i < 8 else 1
...
target_dir = '/home/einsx7/pr/application/polysa_U250_large/0607_manual_ignore_ddr_in_fp'
