...
DDR_loc_2d_y['load_1'] = 0
DDR_loc_2d_y['load_2'] = 0
DDR_loc_2d_y['load_3'] = 0
DDR_loc_2d_x['load_0'] = 0
DDR_loc_2d_x['load_1'] = 0
DDR_loc_2d_x['load_2'] = 0
DDR_loc_2d_x['load_3'] = 0

DDR_loc_2d_y['store_0'] = 0
DDR_loc_2d_y['store_1'] = 0
DDR_loc_2d_y['store_2'] = 0
DDR_loc_2d_y['store_3'] = 0
DDR_loc_2d_x['store_0'] = 1
DDR_loc_2d_x['store_1'] = 1
DDR_loc_2d_x['store_2'] = 1
DDR_loc_2d_x['store_3'] = 1

DDR_enable = [0, 0, 0]
max_usage_ratio_2d = [ [0.7, 0.7], [0.7, 0.7], [0.7, 0.7] ]
...
i = 6
target_dir = f'/home/einsx7/pr/application/soda/1225_test_iter{i}'
tlp_path = f'/home/einsx7/pr/application/soda/dac_iter{i}/tlpc_result'
