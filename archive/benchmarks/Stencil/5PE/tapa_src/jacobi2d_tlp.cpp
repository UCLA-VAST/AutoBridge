    ...
    int32_t input_size_dim_1)
{
    ...
    tlp::task()
      ...
      .invoke<0>( store, var_output_0_0, output_stream_4_0, coalesced_data_num)
      .invoke<0>( store, var_output_0_1, output_stream_4_1, coalesced_data_num)
      .invoke<0>( store, var_output_0_2, output_stream_4_2, coalesced_data_num)
      .invoke<0>( store, var_output_0_3, output_stream_4_3, coalesced_data_num)
    ;
}
